...
public class DurationParserTest {
    ...
    public void parserTest0m() {
        assertEquals(Duration.ofMinutes(0), DurationFormatter.getInstance().parse("0m"));
    }

    @Test
    public void parserTest0h() {
        assertEquals(Duration.ofMinutes(0), DurationFormatter.getInstance().parse("0h"));
    }

    @Test
    public void parserTest30() {
        assertEquals(Duration.ofMinutes(30), DurationFormatter.getInstance().parse("30"));
    }

    @Test
    public void parserTest30m() {
        assertEquals(Duration.ofMinutes(30), DurationFormatter.getInstance().parse("30m"));
    }

    @Test
    public void parserTest60m() {
        assertEquals(Duration.ofMinutes(60), DurationFormatter.getInstance().parse("60m"));
    }

    @Test
    public void parserTest1h() {
        assertEquals(Duration.ofMinutes(60), DurationFormatter.getInstance().parse("1h"));
    }

    @Test
    public void parserTest90m() {
        assertEquals(Duration.ofMinutes(90), DurationFormatter.getInstance().parse("90m"));
    }

    @Test
    public void parserTest1h30m() {
        assertEquals(Duration.ofMinutes(90), DurationFormatter.getInstance().parse("1h 30m"));
    }

    @Test
    public void parserTest1h30mNoSpaces() {
        assertEquals(Duration.ofMinutes(90), DurationFormatter.getInstance().parse("1h30m"));
    }
